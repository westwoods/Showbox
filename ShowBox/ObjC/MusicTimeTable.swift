...
class MusicTimeTable{
	...
	static var splashing_Around:[CMTime] = [kCMTimeZero,
	                                        CMTime(seconds: 5.307, preferredTimescale: 1),
	                                        CMTime(seconds: 9.607, preferredTimescale: 1),
	                                        CMTime(seconds: 11.607, preferredTimescale: 1),
	                                        CMTime(seconds: 19.307, preferredTimescale: 1),
	                                        ...
	                                        CMTime(seconds: 340.451, preferredTimescale: 1),
	                                        CMTime(seconds: 340.451, preferredTimescale: 1),
	                                        CMTime(seconds: 2341.451, preferredTimescale: 1),]
